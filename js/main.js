...
function weatherIconSelec(icon){
    switch(icon) {
    case 1:
        $('#weather-icon').attr({"src":"img/weather/sun-w.png", "alt":"Soleado"});
        break;
    case 2:
        $('#weather-icon').attr({"src":"img/weather/cloud-w.png", "alt":"Parcialmente nublado"});
        break;
    case 3:
        $('#weather-icon').attr({"src":"img/weather/cloud-w.png", "alt":"Parcialmente nublado"});
    case 4:
    ...
    case 5:
        $('#weather-icon').attr({"src":"img/weather/cloud-w.png", "alt":"Parcialmente nublado"});
    case 6:
        $('#weather-icon').attr({"src":"img/weather/cloudy-w.png", "alt":"Nublado"});
    case 7:
        $('#weather-icon').attr({"src":"img/weather/cloudy-w.png", "alt":"Nublado"});
    case 8:
        $('#weather-icon').attr({"src":"img/weather/cloudy-w.png", "alt":"Nublado"});
    case 11:
        $('#weather-icon').attr({"src":"img/weather/cloudy-w.png", "alt":"Nublado"});
    case 12:
        $('#weather-icon').attr({"src":"img/weather/rain-w.png", "alt":"Lluvia"});
    case 13:
        $('#weather-icon').attr({"src":"img/weather/rain-w.png", "alt":"Lluvia"});
    case 14:
        $('#weather-icon').attr({"src":"img/weather/rain-w.png", "alt":"Lluvia"});
    case 15:
        $('#weather-icon').attr({"src":"img/weather/storm-w.png", "alt":"Tormenta eléctrica"});
    case 16:
         $('#weather-icon').attr({"src":"img/weather/storm-w.png", "alt":"Tormenta eléctrica"});
    case 17:
         $('#weather-icon').attr({"src":"img/weather/storm-w.png", "alt":"Tormenta eléctrica"});
    case 18:
        $('#weather-icon').attr({"src":"img/weather/rain-w.png", "alt":"Lluvia"});
    case 33:
        $('#weather-icon').attr({"src":"img/weather/moon-w.png", "alt":"Noche despejada"});
    case 34:
        $('#weather-icon').attr({"src":"img/weather/moon-w.png", "alt":"Noche despejada"});
    case 35:
        $('#weather-icon').attr({"src":"img/weather/cloud-night-w.png", "alt":"Noche nublada"});
    case 36:
        $('#weather-icon').attr({"src":"img/weather/cloud-night-w.png", "alt":"Noche nublada"});
    case 37:
        $('#weather-icon').attr({"src":"img/weather/cloud-night-w.png", "alt":"Noche nublada"});
    case 38:
        $('#weather-icon').attr({"src":"img/weather/cloud-night-w.png", "alt":"Noche nublada"});
    // default:
    //     $('#weather-icon').attr({"src":"img/weather/sun-w.png", "alt":icon});
}
...
$(document).ready(function(){
    ...
    if (sizeDetection()<1191) {
        $('.img-logo').attr({"src":"img/logos/logo-35.png", "margin":"0 10%"});
    }
...
$('.nav-link').click(function(e){
    ...
    $('html, body').animate({scrollTop: (position.top - 86)}, 0);
})